...
FOR %%x IN ("D:\inetpub\wwwroot\drupal801\modules\azure_storage_blob\lib\vendor/pear-pear.php.net/PEAR") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\inetpub\wwwroot\drupal801\modules\azure_storage_blob\lib\vendor/pear-pear.php.net/PEAR"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\inetpub\wwwroot\drupal801\modules\azure_storage_blob\lib\vendor/pear-pear.php.net/PEAR/bin"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\inetpub\wwwroot\drupal801\modules\azure_storage_blob\lib\vendor\bin/composer-php.bat"

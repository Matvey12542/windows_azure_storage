...
if ('D:\inetpub\wwwroot\drupal801\modules\azure_storage_blob\lib\vendor/pear-pear.php.net/PEAR ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('D:\inetpub\wwwroot\drupal801\modules\azure_storage_blob\lib\vendor/pear-pear.php.net/PEAR '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
...
require_once 'PEAR.windows_azure_storage 'PEAR/Frontend.windows_azure_storage 'PEAR/Config.windows_azure_storage 'PEAR/Command.php';
